...
.json-rpc-heading > :deep(.n-text) { flex: 0 0 auto; max-width: 42%; text-align: right; white-space: nowrap; }
...
@media (max-width: 767px) { .json-rpc-heading { flex-direction: column; } .json-rpc-heading > :deep(.n-text) { max-width: none; text-align: left; white-space: normal; } }
</style>
