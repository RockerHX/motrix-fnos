...
- 阶段 4 已启动：FPK 目录骨架、基础图标、Linux x86_64 server 构建入口、Web UI 打包输出、Aria2 sidecar 放置规则和启动/停止脚本已建立，manifest、状态脚本和一键打包链路仍在补齐。
...
- P4-3.3：编写 FPK 状态脚本。未开始
- P4-3.4：补齐 manifest 与权限配置。未开始
- P4-4.1：新增 FPK 一键打包脚本。未开始
- P4-4.2：统一脚本与 CI 构建入口。未开始
- P4-5.1：执行完整打包验证。未开始
- P4-5.2：更新阶段 4 文档状态。未开始
