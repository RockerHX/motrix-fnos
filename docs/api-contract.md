...
```json
{
  ...
  "hasUpdate": true,
  "status": "available",
  "releaseUrl": "https://github.com/RockerHX/motrix-fnos/releases/tag/v1.2.2",
  "assets": [
    {
      "architecture": "x86",
      "name": "motrix.fnos_1.2.2_x86.fpk",
      "downloadUrl": "https://github.com/RockerHX/motrix-fnos/releases/download/v1.2.2/motrix.fnos_1.2.2_x86.fpk"
    },
    {
      "architecture": "arm",
      "name": "motrix.fnos_1.2.2_arm.fpk",
      "downloadUrl": "https://github.com/RockerHX/motrix-fnos/releases/download/v1.2.2/motrix.fnos_1.2.2_arm.fpk"
    }
  ],
