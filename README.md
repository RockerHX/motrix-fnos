...
- 已可生成 x86 与 ARM 包：`packaging/fnos/dist/motrix.fnos_0.2.1_x86.fpk`、`packaging/fnos/dist/motrix.fnos_0.2.1_arm.fpk`。
...
```text
packaging/fnos/dist/motrix.fnos_0.2.1_x86.fpk
packaging/fnos/dist/motrix.fnos_0.2.1_arm.fpk
```
