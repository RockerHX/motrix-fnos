...
- 已可生成 x86 与 ARM 包：`packaging/fnos/dist/motrix.fnos_1.0.0_x86.fpk`、`packaging/fnos/dist/motrix.fnos_1.0.0_arm.fpk`。
...
```text
packaging/fnos/dist/motrix.fnos_1.0.0_x86.fpk
packaging/fnos/dist/motrix.fnos_1.0.0_arm.fpk
```
