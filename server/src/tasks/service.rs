...
use crate::tasks::{
    ...
    mark_magnet_task_reparsing, mark_task_files_confirmed, mark_task_redownloaded,
    mark_task_removed, mark_task_restored, mark_task_resumed, pause_task, prepare_task_with_logs,
