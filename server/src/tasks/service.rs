...
use crate::tasks::{
    ...
    prepare_torrent_task_with_logs, readd_task_to_aria2, reconcile_task_proxy_option, remove_task,
    remove_task_record, remove_task_with_request_id, replace_task_snapshot,
